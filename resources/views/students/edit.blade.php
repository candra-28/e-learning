...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="card-title"><a href="{{ url('students') }}" class="btn btn-success btn-sm">Kembali <i class="mdi mdi-arrow-left-bold-circle-outline"></i></a></div>
                <p class="card-description"> Silahkan Ubah jika memang perlu diubah </p>
                <form class="forms-sample" action="{{ url('student/edit/'.$student->id) }}" method="post" autocomplete="off">
                    @csrf
                    <div class="form-group row">
                        <label for="name" class="col-sm-3 col-form-label">Nomor Induk Siswa</label>
                        <div class="col-sm-9">
                            <input oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" name="nis" value="{{ $student->nis }}" class="form-control">
                            @error('nis')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="entry_year" class="form-control">
                                <option selected>{{ $student->entry_year }}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" name="phone_number" value="{{ $student->phone_number }}" class="form-control">
                            @error('phone_number')
                            <div class="col-sm-12 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="gender" class="form-control">
                                ...
                                <option selected value="{{ $student->gender }}">Pria</option>
                                @else
                                <option selected value="{{ $student->gender }}">Wanita</option>
                                @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="date_of_birth" value="{{ $student->date_of_birth }}" class="form-control" type="date">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="is_active" class="form-control">
                                ...
                                <option selected value="{{ $student->is_active }}">Aktif</option>
                                @else
                                <option selected value="{{ $student->is_active }}">Tidak Aktif</option>
                                @endif
