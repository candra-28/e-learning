            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ url('student/edit/'.$student->id) }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{ $student->name }}" class="form-control" id="name" placeholder="Username">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{ $student->entry_year }}" class="form-control" id="name" placeholder="Username">
                            @error('name')
                            <div class="col-sm-12 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="is_active" class="form-control">
                                ...
                                <option selected disabled value="{{ $student->is_active }}">Aktif</option>
                                @else
                                <option selected disabled value="{{ $student->is_active }}">Tidak Aktif</option>
                                @endif
