            ...
            <div class="card-body">
                ...
                <form class="edit-announcement" action="{{ url('announcement/edit/'.$announcement->acm_id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="acm_title" class="form-control" value="{{ $announcement->acm_title }}" placeholder="Masukan Judul Pengumuman">
                        @error('title')
                    ...
                    <div class="row mt-3">
                        <div class="col-12 mb-4">
                            <div class="text-center mb-2">
                                <img src="{{ asset($announcement->acm_upload_file )}}" id="tampil_picture" style="object-fit: cover; height: 200px; width:230px; text-align:center;">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="acm_description" class="form-control ckeditor" placeholder="Masukan Pesan Pengumuman" value="{{ old('acm_description') }}">{{ $announcement->acm_description }}</textarea>
