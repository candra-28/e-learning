            ...
            <div class="card-body">
                ...
                <form action="{{ url('major/edit/'.$major->mjr_id) }}" method="post" autocomplete="off" class="edit-major" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $major->mjr_name }}" name="mjr_name" class="form-control" placeholder="Masukan nama jurusan">
                    </div>
                    <div class="form-group">
                        <label>Deskripsi Jurusan</label>
                        <textarea name="mjr_description" class="texteditor">{{ $major->mjr_description }}</textarea>
                    </div>
